...
function onSuccess(position) {
  ...
  api = `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&units=metric&appid=da07f73d8fb14bbbc111d0831579c87e`;
  fetchData();
}
...
function requestApi(city) {
  api = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=da07f73d8fb14bbbc111d0831579c87e`;
  fetchData();
}
